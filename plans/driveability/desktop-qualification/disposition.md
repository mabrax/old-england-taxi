...
The next planning topic is **Stage 04 — Zone selection and continuity**: map selection, richer cache behavior and adjacent-cell continuity. This decision records follow-up scheduling; it accepts Stage 03 for the current Linux desktop scope with deferrals, does not claim unconditional all-device qualification, and does not authorize Stage 04 implementation. The reviewed implementation and qualification are integrated in main at `b1a5d06`.
